...
export const chatPresets: ChatPreset[] = [
  ...
  // Technical Analysis
  {
    ...
    question: 'What are the trend and key support/resistance levels?',
  ...
  },
  {
    ...
    question: 'Do you see triangles, flags, or double bottoms?',
  ...
  },
  {
    ...
    question: "What's the RSI, MACD, and momentum like today?",
  ...
  },
  {
    ...
    question: 'Where should I set my target and stop loss?',
  ...
  },
  {
    ...
    question: 'Is it bullish on daily and weekly charts?',
  ...
  },
  {
    ...
    question: "Give me one short risk note about the current setup.",
